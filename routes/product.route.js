...
route.post(
    "/product-approved",
    token.verifyToken,
    productController.isApproved
);

route.post("/product-search", productController.searchProduct);

route.post(
    "/product-approved-cancel",
    token.verifyToken,
    productController.isApprovedCancel
);
...
route.post(
    ...
    token.verifyToken,
    productController.productListBySeller
);

route.post("/product-by-id", token.verifyToken, productController.productById);

route.post(
    "/approved-product-list-by-seller",
    token.verifyToken,
    productController.approvedProductListBySeller
);

route.post(
    "/cancel-product-list-by-seller",
    token.verifyToken,
    productController.cancelProductListBySeller
);

route.post(
    "/cancel-product-auction",
    token.verifyToken,
    productController.cancelProductAuction
);
