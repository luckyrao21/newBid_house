...
router.post(
    "/view-OneProduct-bidlist",
    token.verifyToken,
    bidController.viewOneProductBid
);

router.post("/bid-lock", token.verifyToken, bidController.lockBid);

router.post("/bidded-product", bidController.biddedProduct);
