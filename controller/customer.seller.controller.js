    ...
    customerSeller
        ...
        .then((result) => {
            ...
            var message = {
                ...
                html: '<p>you are a nice person for signing up with Book-Us-Meal! You must follow this link within 30 days of registration to activate your account:</p><a href= "https://book-us-meal.herokuapp.com/customer/verify-account/' +
                    result._id +
                    '">click here</a><p>Have fun, and dont hesitate to contact us with your feedback</p><br><p> The Book-Us-Meal Team</p><a href="#">book-us-meal@gmail.com</a>',
            };
    ...
    customerSeller
        ...
        .then((result) => {
            if (result) {
                ...
                return response
                    .status(201)
                    .json({ status: "login success", data: result, token: token });
            } else {
    ...
    customerSeller
        ...
        .then((result) => {
            ...
            if (result) {
                ...
                return response
                    .status(200)
                    .json({ success: "check your email", result: result });
            } else {
                return response
                    .status(200)
...
exports.resetPassword = (request, response) => {
    customerSeller
        .updateOne({ email: request.body.email }, {
            $set: {
